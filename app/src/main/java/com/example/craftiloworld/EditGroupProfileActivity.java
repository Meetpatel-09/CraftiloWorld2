...
public class EditGroupProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().setCropShape(CropImageView.CropShape.OVAL).start(EditGroupProfileActivity.this);
            }
        });
    ...
    private void updateProfile() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Groups").child(fUser.getUid()).updateChildren(map);
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        pd.dismiss();
                        Toast.makeText(EditGroupProfileActivity.this, "Upload Failed!!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
